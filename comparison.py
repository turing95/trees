...
def main(argv):
    ...
    for train_index, test_index in kf.split(x):
        ...
        solving_time_benders_oct_no_p = end_time - start_time
        ...
        primal_oct_no_p.print_results(solving_time_oct_no_p)
        ...
        reg_res_oct_no_p, mae_oct_no_p, mse_oct_no_p, r2_oct_no_p, r2_lad_alt_oct_no_p = primal_oct_no_p.get_accuracy(
            data_train)

        _, mae_oct_no_p_test, _, _, r2_lad_alt_oct_no_p_test = primal_oct_no_p.get_accuracy(data_test)
        ...
        mip_gaps_oct_no_p.append(primal_oct_no_p.model.getAttr("MIPGap") * 100)
    ...
    print('solving times oct_with_p', solving_times_oct_no_p)
    ...
    print('maes oct_with_p', maes_train_oct_no_p)
    ...
    print('maes oct_with_p test', maes_test_oct_no_p)
    ...
    row_7 = [approach_name_7, input_file, train_len, features_count, depth, n_k_folds, time_limit,
             np.average(mip_gaps_oct_no_p) * 100,
             np.average(solving_times_oct_no_p), np.average(maes_train_oct_no_p),
             np.average(r2_lads_train_oct_no_p),
    ...
    result_file_oct_no_p = out_put_name_7 + '.csv'
