...
def main(argv):
    ...
    row_1 = [approach_name_1, input_file, depth, n_k_folds, time_limit, np.average(mip_gaps_no_pi) * 100,
    ...
    row_2 = [approach_name_2, input_file, depth, n_k_folds, time_limit, np.average(mip_gaps_binary) * 100,
    ...
    row_3 = [approach_name_3, input_file, depth, n_k_folds, time_limit, np.average(mip_gaps_oct_no_p) * 100,
    ...
    row_4 = [approach_name_4, input_file, depth, n_k_folds, time_limit, np.average(mip_gaps_benders_oct_with_p) * 100,
    ...
    row_5 = [approach_name_5, input_file, depth, n_k_folds, time_limit, np.average(mip_gaps_with_pi) * 100,
