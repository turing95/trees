...
def main(argv):
    ...
    data = pd.read_csv(data_path + f'{input_file}_enc_reg.csv')
    ...
    for i in range(1, 6):
        data_train = pd.read_csv(data_path + f'{input_file}_train_{i}.csv')
        data_test = pd.read_csv(data_path + f'{input_file}_test_{i}.csv')
        ##########################################################
    ...
    row_4 = [approach_name_4, input_file, train_len, features_count, depth, time_limit,
    ...
    row_6 = [approach_name_6, input_file, train_len, features_count, depth, time_limit,
    ...
    row_7 = [approach_name_7, input_file, train_len, features_count, depth, time_limit,
    ...
    row_8 = [approach_name_8, input_file, train_len, features_count, depth, time_limit,
